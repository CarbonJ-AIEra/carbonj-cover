...
| ima | `ima.png` | ima、个人知识库、知识库问答和知识库广场主题 |
...
- 新增高频产品后，同步更新本文件、配置的 `generate_carbonj_cover.py` 自动匹配表；设置了 `product_asset_mirror` 时再更新镜像目录里的说明文件。
...
- ima 官网 favicon：`https://static.ima.qq.com/ima/assets/chat/favicon.svg`；长期资产使用同图形转换的 640×640 透明 PNG / SVG
